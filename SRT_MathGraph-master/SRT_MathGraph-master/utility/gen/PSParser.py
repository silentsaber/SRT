...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write(u"\32\34\36 \"$&(*,.\60\62\64\668:<>@BDF\2\b\3\2\66:\3")
        buf.write(u"\2\5\6\5\2\7\b+-\62\62\4\2\64\64<<\3\2\25)\3\2\23\24")
        ...
        buf.write(u"\2\2\2RS\3\2\2\2S\5\3\2\2\2TR\3\2\2\2UV\5\b\5\2VW\7\66")
        ...
        buf.write(u"\60\2\2\u00ab\u00ae\7\13\2\2\u00ac\u00af\5\b\5\2\u00ad")
        buf.write(u"\u00af\5\6\4\2\u00ae\u00ac\3\2\2\2\u00ae\u00ad\3\2\2")
        buf.write(u"\2\u00af\u00b0\3\2\2\2\u00b0\u00b1\7\f\2\2\u00b1\35\3")
        buf.write(u"\2\2\2\u00b2\u00b3\7\61\2\2\u00b3\u00b6\7\13\2\2\u00b4")
        ...
        buf.write(u"\3\2\2\2\u0149\u014d\7\63\2\2\u014a\u014d\5\62\32\2\u014b")
        ...
        buf.write(u"\2\u016f\u016e\3\2\2\2\u01709\3\2\2\2\u0171\u0172\7\60")
        buf.write(u"\2\2\u0172\u0173\7\13\2\2\u0173\u0174\t\5\2\2\u0174\u0175")
        buf.write(u"\7\21\2\2\u0175\u017a\5\b\5\2\u0176\u0177\7\61\2\2\u0177")
        ...
        buf.write(u"\b\2\u0186?\3\2\2\2\u0187\u018d\7\60\2\2\u0188\u018e")
        buf.write(u"\5,\27\2\u0189\u018a\7\13\2\2\u018a\u018b\5\b\5\2\u018b")
        buf.write(u"\u018c\7\f\2\2\u018c\u018e\3\2\2\2\u018d\u0188\3\2\2")
        buf.write(u"\2\u018d\u0189\3\2\2\2\u018eA\3\2\2\2\u018f\u0195\7\61")
        buf.write(u"\2\2\u0190\u0196\5,\27\2\u0191\u0192\7\13\2\2\u0192\u0193")
        buf.write(u"\5\b\5\2\u0193\u0194\7\f\2\2\u0194\u0196\3\2\2\2\u0195")
        buf.write(u"\u0190\3\2\2\2\u0195\u0191\3\2\2\2\u0196C\3\2\2\2\u0197")
        buf.write(u"\u0198\7\60\2\2\u0198\u0199\7\13\2\2\u0199\u019a\5\6")
        buf.write(u"\4\2\u019a\u019b\7\f\2\2\u019bE\3\2\2\2\u019c\u019d\7")
        buf.write(u"\60\2\2\u019d\u019e\7\13\2\2\u019e\u019f\5\6\4\2\u019f")
        buf.write(u"\u01a0\7\f\2\2\u01a0G\3\2\2\2.Rcny\u0081\u0083\u008b")
        buf.write(u"\u008e\u0094\u009b\u00a0\u00a8\u00ae\u00b6\u00c4\u00c7")
        buf.write(u"\u00cb\u00d8\u00db\u00df\u00e7\u00ed\u00fb\u0103\u0108")
        buf.write(u"\u0112\u0121\u0124\u0127\u012a\u012c\u0133\u0137\u0144")
        buf.write(u"\u0147\u014c\u0153\u0160\u0168\u016f\u017a\u0183\u018d")
        buf.write(u"\u0195")
        return buf.getvalue()
...
class PSParser ( Parser ):
    ...
    def func_normal(self):
        ...
        try:
            ...
            self.state = 283
            _la = self._input.LA(1)
            if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << PSParser.FUNC_OVERLINE) | (1 << PSParser.FUNC_LOG) | (1 << PSParser.FUNC_LN) | (1 << PSParser.FUNC_SIN) | (1 << PSParser.FUNC_COS) | (1 << PSParser.FUNC_TAN) | (1 << PSParser.FUNC_CSC) | (1 << PSParser.FUNC_SEC) | (1 << PSParser.FUNC_COT) | (1 << PSParser.FUNC_ARCSIN) | (1 << PSParser.FUNC_ARCCOS) | (1 << PSParser.FUNC_ARCTAN) | (1 << PSParser.FUNC_ARCCSC) | (1 << PSParser.FUNC_ARCSEC) | (1 << PSParser.FUNC_ARCCOT) | (1 << PSParser.FUNC_SINH) | (1 << PSParser.FUNC_COSH) | (1 << PSParser.FUNC_TANH) | (1 << PSParser.FUNC_ARSINH) | (1 << PSParser.FUNC_ARCOSH) | (1 << PSParser.FUNC_ARTANH))) != 0)):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def func(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [PSParser.FUNC_OVERLINE, PSParser.FUNC_LOG, PSParser.FUNC_LN, PSParser.FUNC_SIN, PSParser.FUNC_COS, PSParser.FUNC_TAN, PSParser.FUNC_CSC, PSParser.FUNC_SEC, PSParser.FUNC_COT, PSParser.FUNC_ARCSIN, PSParser.FUNC_ARCCOS, PSParser.FUNC_ARCTAN, PSParser.FUNC_ARCCSC, PSParser.FUNC_ARCSEC, PSParser.FUNC_ARCCOT, PSParser.FUNC_SINH, PSParser.FUNC_COSH, PSParser.FUNC_TANH, PSParser.FUNC_ARSINH, PSParser.FUNC_ARCOSH, PSParser.FUNC_ARTANH]:
                self.enterOuterAlt(localctx, 1)
                self.state = 285
                self.func_normal()
                self.state = 298
